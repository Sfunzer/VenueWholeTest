public class Main {
    ...
    public static void main(String[] args) {
        ...
        userAddSuccessful = mainUsers.addUser("Sven de Hoog", "cherrycoke1", "cherrycoke1");
        ...
        doubleReservation = mainReservations.addReservation("Elbow", "Jodrel Banks", "Needs Digico and D&B PA", activeUser, "2016-03-10T21:00:00", "2016-03-10T23:15:00");
        ...
        doubleReservation = mainReservations.addReservation("Queen", "Wembley Stadium", "Needs Midas H3000 and StageCo Stack", activeUser, "1980-03-10T21:00:00", "2080-03-10T23:15:00");
        if (doubleReservation) {
            System.out.println("Date/Time is already booked. Reservation is not made.");
        } else {
            System.out.println("Reservation Made");
        }
        doubleReservation = mainReservations.addReservation("Chris Rea", "The road home", "Needs red lights all around", activeUser, "2020-12-24T18:00:00", "2020-12-26T23:59:59");
        if (doubleReservation) {
            System.out.println("Date/Time is already booked. Reservation is not made.");
        } else {
            System.out.println("Reservation Made");
...
/* To-do:
TODO: Turn duplicate code into methods in here, or in classes is possible.
 */